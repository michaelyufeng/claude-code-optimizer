...
echo "  3. 使用 /project-optimizer:plan 开始规划任务"
echo ""
echo "可用命令："
echo "  /project-optimizer:plan [任务描述]      - 规划任务"
echo "  /project-optimizer:review [文件/范围]   - 代码审查"
echo "  /project-optimizer:fix-issue [issue号]  - 修复 GitHub Issue"
echo "  /project-optimizer:checkpoint [描述]    - 保存进度检查点"
